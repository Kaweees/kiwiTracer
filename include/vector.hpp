...
class Vector3D {
  public:
    ...
    double magnitude() const { return this->x * this->x + this->y * this->y + this->z * this->z; }
...
// Overload the multiplication operator (vector * scalar)
inline Vector3D operator*(double t, const Vector3D& vec) { return Vector3D(t * vec.x, t * vec.y, t * vec.z); }

// Overload the multiplication operator (vector * scalar)
inline Vector3D operator*(const Vector3D& vec, double t) { return Vector3D(t * vec.x, t * vec.y, t * vec.z); }

// Overload the division operator (vector / scalar)
inline Vector3D operator/(Vector3D vec, double t) { return Vector3D(vec.x / t, vec.y / t, vec.z / t); }

// Get the dot product of two vectors
inline double dot(const Vector3D& u, const Vector3D& v) { return u.x * v.x + u.y * v.y + u.z * v.z; }
